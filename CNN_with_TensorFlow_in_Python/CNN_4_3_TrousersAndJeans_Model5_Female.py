...
data_train = np.load(r"CNN_with_TensorFlow_in_Python/Dataset/Trousers & Jeans - Female - Train.npz")
data_val = np.load(r"CNN_with_TensorFlow_in_Python/Dataset/Trousers & Jeans - Female - Validation.npz")
data_test = np.load(r"CNN_with_TensorFlow_in_Python/Dataset/Trousers & Jeans - Female - Test.npz")
